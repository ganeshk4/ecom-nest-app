...
create table CART_SNAPSHOT (
  ...
  STATUS enum('VERIFICATION_PENDING', 'VERIFIED'),
  PAYABLE_AMOUNT decimal(10,2) DEFAULT 0,
  PAID_AMOUNT decimal(10,2) DEFAULT 0,
  TOTAL_TAX_AMOUNT decimal(10,2) unsigned NOT NULL DEFAULT 0,
  TOTAL_SELLING_PRICE_BT decimal(10,2) NOT NULL DEFAULT 0,
  RZ_PAYMENT_ID varchar(50),
  RZ_ORDER_ID varchar(50),
  RZ_SIGNATURE varchar(100),
  FROM_WEBHOOK tinyint,
  RZ_RESPONSE JSON,
  CREATED_AT timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  MODIFIED_AT timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  primary key (ID),
  CONSTRAINT CART_SNAPSHOT_ibfk_1 FOREIGN KEY (USER_ID) REFERENCES USER (ID)
);

alter table CART_SNAPSHOT add CONSTRAINT CART_SNAPSHOT_ibfk_2 FOREIGN KEY (ORDER_ID) REFERENCES EC_ORDER (ID)

create table CART_SNAPSHOT_ITEM (
  ID INT(11) unsigned NOT NULL AUTO_INCREMENT,
  CART_SN_ID int(11) unsigned NOT NULL,
  USER_ID int(11) unsigned NOT NULL,
  PRODUCT_ID int(11) unsigned NOT NULL,
  NAME varchar(100),
  SELLING_PRICE_AT decimal(10,2) unsigned NOT NULL,
  ...
  MODIFIED_AT timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  primary key (ID),
  CONSTRAINT CART_SNAPSHOT_ITEM_ibfk_1 FOREIGN KEY (CART_SN_ID) REFERENCES CART_SNAPSHOT (ID),
  CONSTRAINT CART_SNAPSHOT_ITEM_ibfk_2 FOREIGN KEY (USER_ID) REFERENCES USER (ID)
);
...
create table EC_ORDER (
  ...
  USER_ID int(11) unsigned NOT NULL,
  CART_SN_ID int(11) unsigned NOT NULL,
  STATUS enum('PLACED', 'QUEUED', 'COMPLETED'),
  PAYABLE_AMOUNT decimal(10,2) DEFAULT 0,
  PAID_AMOUNT decimal(10,2) DEFAULT 0,
  TOTAL_TAX_AMOUNT decimal(10,2) unsigned NOT NULL DEFAULT 0,
  TOTAL_SELLING_PRICE_BT decimal(10,2) NOT NULL DEFAULT 0,
  ...
  CONSTRAINT ORDERS_ibfk_2 FOREIGN KEY (CART_SN_ID) REFERENCES CART_SNAPSHOT (ID)
);

alter table CART_SNAPSHOT add CONSTRAINT CART_SNAPSHOT_ibfk_2 FOREIGN KEY (ORDER_ID) REFERENCES EC_ORDER (ID);
alter table EC_ORDER MODIFY COLUMN STATUS enum('PLACED', 'QUEUED', 'COMPLETED');
...
create table ORDER_ITEM (
  ...
  PRODUCT_ID int(11) unsigned NOT NULL,
  NAME varchar(100),
  STATUS enum('PLACED', 'DISPATCHED', 'DELIVERED'),
  SELLING_PRICE_AT decimal(10,2) unsigned NOT NULL,
  TAX_AMOUNT decimal(10,2) unsigned NOT NULL,
  TAX_PERCENT decimal(4,2) unsigned NOT NULL,
  SELLING_PRICE_BT decimal(10,2) NOT NULL,
  ...
  MODIFIED_AT timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  primary key (ID),
  CONSTRAINT ORDER_ITEM_ibfk_1 FOREIGN KEY (ORDER_ID) REFERENCES EC_ORDER (ID),
